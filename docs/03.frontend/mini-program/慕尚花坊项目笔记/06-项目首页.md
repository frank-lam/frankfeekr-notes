...
<img src="assets/首页功能.gif" style="zoom:70%; border: 1px solid #ccc" />
...
<img src="assets/02-轮播图.gif" style="zoom:80%; border: 1px solid #ccc" />
...
<img src="assets/02-轮播图-171146720689633.gif" style="zoom:80%; border: 1px solid #ccc" />
...
<img src="assets/02-导航分类.jpg" style="zoom:80%; border: 1px solid #ccc" />
...
​                <img src="assets/猜你喜欢.gif" style="zoom:70%; border: 1px solid #ccc" />        <img src="assets/人气推荐.gif" style="zoom:70%; border: 1px solid #ccc" />   
...
1. 使用微信开发者工具为**当前正在预览的页面**生成骨架屏代码，工具入口位于模拟器面板右下角三点处
   ...
   <img src="assets/生成骨架屏.jpg" style="zoom:60%;" />
...
2. 点击生成骨架屏，将有弹窗提示是否允许插入骨架屏代码。
   ...
   <img src="assets/确认是否生成骨架屏.jpg" style="zoom:80%;" />
...
5. 查看页面效果
   ...
   <img src="assets/骨架屏.gif" style="zoom:50%; border: 1px solid #ccc" />
